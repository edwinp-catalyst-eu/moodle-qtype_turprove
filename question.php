...
/**
 * TUR Prove question definition classes.
 *
 * @package    qtype
 * @subpackage turprove
...
/**
 * Base class for TUR Prove questions. The parts that are common to
...
abstract class qtype_turprove_base extends question_graded_automatically {
    ...
    public function check_file_access($qa, $options, $component, $filearea, $args, $forcedownload) {
        if ($component == 'question' && in_array($filearea,
            ...
            // turprove question type. It would be good to refactor to
...
/**
 * Represents a question where multiple choices can be selected.
 *
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
