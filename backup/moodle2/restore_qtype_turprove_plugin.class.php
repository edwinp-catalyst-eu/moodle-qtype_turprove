...
class restore_qtype_turprove_plugin extends restore_qtype_plugin {
    ...
    public function process_turprove($data) {
        ...
        if ($questioncreated) {
            ...
            if (!$DB->record_exists('qtype_turprove_options', array('questionid' => $data->questionid))) {
                $newitemid = $DB->insert_record('qtype_turprove_options', $data);
                $this->set_mapping('qtype_turprove_options', $oldid, $newitemid);
            }
        }
    }
    ...
    public static function define_decode_contents() {
        ...
        $contents[] = new restore_decode_content('qtype_turprove_options',
                $fields, 'qtype_turprove_options');
